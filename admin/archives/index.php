...
?>
    <tr>
        ...
        <td>
            <?php 
            // Check if curriculum_id exists in $cur_arr before accessing it
            if (isset($cur_arr[$row['curriculum_id']])) {
                echo $cur_arr[$row['curriculum_id']];
            } else {
                echo "Curriculum not found"; // Replace with appropriate fallback or error handling
            }
            ?>
        </td>
        <td class="text-center">
            ...
            switch ($row['status']) {
                ...
                case '0':
                    ...
                    break;
                default:
                    echo "<span class='badge badge-warning badge-pill'>Unknown Status</span>";
                    break;
            }
            ?>
        </td>
