  ...
  <div class="h-100 d-flex align-items-center w-100" id="login">
    ...
    <div class="col-5 h-100 bg-gradient">
      <div class="d-flex w-100 h-100 justify-content-center align-items-center">
        <div class="card col-sm-12 col-md-6 col-lg-3 card-outline card-primary" style="border-color: #800000;">
                ...
                <div class="row justify-content-center">
                  <div class="col-lg-12">
                    <div class="form-group text-center">
                       <button type="submit" class="btn-maroon btn btn-default btn-long" style="background-color: #800000; color: white;">Login</button>
                    </div>
