...
<!-- Navbar -->
      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0" id="login-nav" style="background-color: #800000;">
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            <?php if($_settings->userdata('id') > 0): ?>
              ...
              <span class="mx-2 text-light me-2"><?= !empty($_settings->userdata('email')) ? $_settings->userdata('email') : $_settings->userdata('username') ?></span>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a href="./?page=projects" class="nav-link <?= isset($page) && $page =='projects' ? "active" : "" ?>">Thesis</a>
              </li>
              ...
              <li class="nav-item">
                <a href="./?page=submit-archive" class="nav-link <?= isset($page) && $page =='submit-archive' ? "active" : "" ?>">Archive Thesis</a>
              </li>
              <?php endif; ?>
            </ul>
